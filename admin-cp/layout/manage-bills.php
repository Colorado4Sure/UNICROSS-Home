<div class="pcoded-content">
      ...
      <div class="row align-items-end">
         <div class="col-lg-8">
            <div class="page-header-title">
               <i class="bg-c-blue"><img src="./assets/icons/pay-bills.png" width="90%" height="90%"></i>
               <div class="d-inline">
                  <h5><?= $page?></h5>
                  <span>Enable / disable bills</span>
               </div>
            </div>
         </div>
      </div>
            ...
            <div class="page-body">
               <div class="col-12 card">
                  ...
                  <div class="card-block">
                    <?php if($site->features->bills->value === false):?>
                      <h6 class="font-weight-bold text-danger">Bills feature is diabled. Enable it in site settings</h6>
                    <?php endif?>
   ...
   <script type="text/javascript">
     $.ajax({
         url: '<?=$siteurl?>/api/get-services?table=true',
         type: 'POST',
         dataType: "json",
         cache: false,
